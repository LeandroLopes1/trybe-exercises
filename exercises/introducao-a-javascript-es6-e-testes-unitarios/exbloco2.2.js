const lesson1 = {
  ...
  //Exercico 1 - Crie uma função para adicionar o turno da manhã na lesson2 . 
  ...
  //Exercicio 5 - Crie um objeto de nome allLessons , que deve agrupar todas as aulas através do Object.assign . 
  ...
  //Exercicio 8 - Crie uma função que verifique se o par (chave / valor) existe na função. 
  ...
  // exercicio 1 Bonus Crie uma função para contar quantos estudantes assistiram às aulas de matemática. Use o objeto criado no exercício 5.
  ...
  // exercicio 2 Bonus Crie uma função que deverá retornar um objeto que representa o relatório do professor ou professora, 
